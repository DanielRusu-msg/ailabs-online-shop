...
class ProductControllerTest {
    ...
    void getAll_returnsProducts() throws Exception {
        ...
        mockMvc.perform(get("/products"))
                ...
                .andExpect(jsonPath("$[0].supplier.id").value(supplierId.toString()))
                .andExpect(jsonPath("$[0].supplier.name").value("TechGlobal Distribution"));
    }
    ...
    private ProductResponseDto productResponse(UUID id, String name) {
        return ProductResponseDto.builder()
                ...
                .supplier(SupplierDto.builder().id(supplierId).name("TechGlobal Distribution").build())
                .build();
    }
}
