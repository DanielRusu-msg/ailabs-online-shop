...
class SupplierControllerTest {
    ...
    void getAll_returnsSuppliers() throws Exception {
        Supplier supplier = Supplier.builder().id(supplierId).name("TechGlobal Distribution").build();
        SupplierDto dto = supplierDto(supplierId, "TechGlobal Distribution");
        ...
        mockMvc.perform(get("/suppliers"))
                ...
                .andExpect(jsonPath("$[0].name").value("TechGlobal Distribution"));
    }
    ...
    void getById_returnsSupplier_whenFound() throws Exception {
        ...
        mockMvc.perform(get("/suppliers/{id}", supplierId))
                ...
                .andExpect(jsonPath("$.name").value("TechGlobal Distribution"));
    }
